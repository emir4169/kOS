...
ramdisk_fs ramfs_init() {
    ...
    unsigned char* file3_data = (unsigned char*) kmalloc(48);
    // thank god to https://defuse.ca/online-x86-assembler.htm
    unsigned char _temp_data[] = { 0xB8, 0x03, 0x00, 0x00, 0x00, 0xBB, 0x04, 0x00, 0x00, 0x00, 0xCD, 0x80, 0xC6, 0x03, 0x41, 0xC6, 0x43, 0x01, 0x42, 0xC6, 0x43, 0x02, 0x0A, 0xC6, 0x43, 0x03, 0x00, 0xB8, 0x02, 0x00, 0x00, 0x00, 0xB9, 0x03, 0x00, 0x00, 0x00, 0xCD, 0x80, 0xB8, 0x48, 0x00, 0x00, 0x00, 0x90, 0xC3 }; // MOV EAX, 0x48; NOP; RET
